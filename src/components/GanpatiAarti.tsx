  ...
  return (
    <div className="aarti-container bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto mt-6 border border-white/20">
      ...
      <div className="aarti-verses space-y-4 text-center">
        ...
        <div className="chorus bg-gradient-to-r from-festive-gold/20 to-festive-accent/20 rounded-lg p-3 my-4">
        ...
        <div className="final-prayer mt-6 p-4 bg-festive-primary/10 rounded-xl">
